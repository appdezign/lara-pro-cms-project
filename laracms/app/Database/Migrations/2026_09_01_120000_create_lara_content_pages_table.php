...
return new class extends Migration
{
    ...
    {
        Schema::create('lara_content_pages', function (Blueprint $table) {
            $table->bigIncrements('id');
            $table->unsignedBigInteger('user_id')->index('lara_content_pages_user_id_foreign');
    ...
    {
        Schema::dropIfExists('lara_content_pages');
    }
};
