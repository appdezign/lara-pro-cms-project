...
return new class extends Migration
{
    ...
    {
        Schema::create('lara_content_services', function (Blueprint $table) {
            $table->bigIncrements('id');
            $table->unsignedBigInteger('user_id')->index('lara_content_services_user_id_foreign');
            ...
            $table->unsignedBigInteger('locked_by')->nullable()->index('lara_content_services_locked_by_foreign');
        });
    }
    ...
    {
        Schema::dropIfExists('lara_content_services');
    }
};
