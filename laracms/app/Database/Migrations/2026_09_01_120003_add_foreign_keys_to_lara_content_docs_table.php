...
return new class extends Migration
{
    ...
    {
        Schema::table('lara_content_docs', function (Blueprint $table) {
    ...
    {
        Schema::table('lara_content_docs', function (Blueprint $table) {
            $table->dropForeign('lara_content_docs_locked_by_foreign');
            $table->dropForeign('lara_content_docs_user_id_foreign');
        });
    }
};
