...
return new class extends Migration
{
    ...
    {
        Schema::table('lara_content_galleries', function (Blueprint $table) {
    ...
    {
        Schema::table('lara_content_galleries', function (Blueprint $table) {
            $table->dropForeign('lara_content_galleries_locked_by_foreign');
            $table->dropForeign('lara_content_galleries_user_id_foreign');
        });
    }
};
