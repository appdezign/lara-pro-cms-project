...
return new class extends Migration
{
    ...
    {
        Schema::table('lara_content_locations', function (Blueprint $table) {
    ...
    {
        Schema::table('lara_content_locations', function (Blueprint $table) {
            $table->dropForeign('lara_content_locations_locked_by_foreign');
            $table->dropForeign('lara_content_locations_user_id_foreign');
        });
    }
};
