...
return new class extends Migration
{
    ...
    {
        Schema::table('lara_content_products', function (Blueprint $table) {
    ...
    {
        Schema::table('lara_content_products', function (Blueprint $table) {
            $table->dropForeign('lara_content_products_locked_by_foreign');
            $table->dropForeign('lara_content_products_user_id_foreign');
        });
    }
};
