...
return new class extends Migration
{
    ...
    {
        Schema::table('lara_content_services', function (Blueprint $table) {
    ...
    {
        Schema::table('lara_content_services', function (Blueprint $table) {
            $table->dropForeign('lara_content_services_locked_by_foreign');
            $table->dropForeign('lara_content_services_user_id_foreign');
        });
    }
};
